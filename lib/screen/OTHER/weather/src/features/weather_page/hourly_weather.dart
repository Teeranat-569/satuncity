...
import 'package:satuncity/screen/OTHER/weather/src/features/weather_page/hourly_weather_controller.dart';
      ...
      child: Column(
        children: [
          Text(
            ...
            style: textTheme.caption.copyWith(fontWeight: fontWeight,color: Colors.white),
          ),
          ...
          Text(
            '$temp°',
            style: textTheme.bodyText1.copyWith(fontWeight: fontWeight,color: Colors.white),
          ),
        ],
      ),
    );
