...
class EditRegionData extends StatefulWidget {
  ...
  EditRegionData({Key key, this.travelName, this.travelCate, this.docid})
      : super(key: key);
  @override
  _EditRegionDataState createState() => _EditRegionDataState();
}

class _EditRegionDataState extends State<EditRegionData> {
  ...
  var collection = FirebaseFirestore.instance.collection('travel_region');
